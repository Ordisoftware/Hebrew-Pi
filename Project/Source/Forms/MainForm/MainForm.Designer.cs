namespace Ordisoftware.Hebrew.Pi
{
  partial class MainForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.RemainingRate = new System.Windows.Forms.DataGridViewTextBoxColumn();
      ...
      // RemainingRate
      // 
      this.RemainingRate.DataPropertyName = "RemainingRate";
      this.RemainingRate.HeaderText = "Remaining rate";
      this.RemainingRate.Name = "RemainingRate";
      this.RemainingRate.ReadOnly = true;
      this.RemainingRate.Width = 110;
      // 
      // ColumnElapsedCount
      // 
    ...
    private DataGridViewTextBoxColumn RemainingRate;
  }
}
